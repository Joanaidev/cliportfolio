...
const JoanPortfolio = () => {
  ...
  const caseStudies = [
    {
      ...
      businessImpact: "$10M+ portfolio management, 200+ enterprise clients, billions in transaction volume",
      icon: Zap,
  ...
  const handleAIChat = (message: string) => {
    ...
    const responses = {
      ...
      "bitwave": "At Bitwave, I'm transforming how enterprise crypto accounting operates. With 200+ clients managing $10M+ portfolios, precision isn't optional. My systems predict issues weeks before they impact customers, maintaining 98% accuracy while serving billions in transaction volume.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50 font-['Inter']">
      {/* Navigation */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-600">AI Operations Leader • Program Executive • Team Builder</p>
            </div>
            <div className="flex flex-wrap gap-4 sm:gap-8 text-sm sm:text-base">
              {[
                ...
                <button 
                  ...
                  className={`${activeSection === item.key ? 'text-pink-600 font-semibold' : 'text-gray-700 hover:text-pink-600'} font-medium transition-colors`}
                >
                  {item.label}
                </button>
              ))}
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="animate-slide-up">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-pink-100 shadow-lg mb-8">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-700"><strong>Revenue Impact:</strong> Delivered 60% MRR growth across multiple $500K+ ARR clients</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                    <span className="text-gray-700"><strong>Cost Optimization:</strong> $2M+ annual savings through predictive AI systems</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                    <span className="text-gray-700"><strong>Team Leadership:</strong> 8-person global team across 4 time zones</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-pink-500 rounded-full"></div>
                    <span className="text-gray-700"><strong>Enterprise Scale:</strong> 200+ clients, $100M+ portfolio value</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <a 
                  ...
                  className="bg-gradient-to-r from-pink-500 to-rose-500 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-center hover:shadow-lg transform hover:scale-105 transition-all duration-200 inline-flex items-center justify-center gap-2"
                >
                ...
                <a 
                  ...
                  className="bg-white text-pink-600 border-2 border-pink-500 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-center hover:bg-pink-50 transition-all duration-200 inline-flex items-center justify-center gap-2"
                >
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="metric-card rounded-xl p-6 text-center">
                  ...
                  <div className="text-xs text-gray-500 mt-1">Enterprise Impact</div>
                </div>
                <div className="metric-card rounded-xl p-6 text-center">
                  <div className="text-3xl font-bold gradient-text mb-2">$100M+</div>
                  <div className="text-sm text-gray-600">Portfolio Value</div>
                  <div className="text-xs text-gray-500 mt-1">Under Management</div>
                </div>
              </div>
                  ...
                  <div className="text-center">
                    <div className="flex justify-center items-end space-x-2 h-24 mb-2">
                      ...
                      <div className="bg-gradient-to-t from-orange-500 to-orange-300 w-8 rounded-t-lg" style={{height: '75%'}}>
                        <div className="text-xs text-white font-semibold p-1 text-center">8</div>
                      </div>
                    </div>
        ...
        <section className="bg-white/50 backdrop-blur-sm py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">AI-Powered Program Leadership</h2>
              <p className="text-xl text-gray-600">Growth-focused SaaS program leader with a strong track record in AI-driven operations, enterprise workflow automation, and customer success strategy. I specialize in helping high-growth fintech and SaaS organizations eliminate operational friction, scale intelligently, and unlock new revenue through predictive systems that think ahead and execute at scale.</p>
            </div>
                ...
                <div className="bg-white rounded-xl p-6 shadow-lg border border-pink-100">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mb-4">From churn prevention models to lifecycle health scoring systems, I've led CS strategy across Series A-B startups and enterprise SaaS. My programs have delivered 30+ point retention gains, 40–60% MRR growth, and boosted upsells through predictive segmentation, automation, and cross-functional enablement.</p>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-200">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                      <span className="text-gray-700">98% prediction accuracy for risk signals across $10M+ portfolios</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
